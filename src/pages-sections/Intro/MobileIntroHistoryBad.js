                ...
                { lectures.map(
                  (lec, index, arr) => {
                    ...
                    return( <TableRow key={lec.id} className = {tableClasses.root} style={{backgroundColor:"#FFFFFF",width:"100%"}}>
                              {/* <TableCell align="center" style={{width:"100%"}}> <p style={{textOverflow:"ellipsis",whiteSpace:"nowrap",wordWrap:"normal",width:Bwidth/12,overflow:"hidden"}}>{category_content}</p> </TableCell> */}
                              <TableCell align="center" style={{width:"100px"}}> <p style={{textOverflow:"ellipsis",whiteSpace:"nowrap",wordWrap:"normal",width:Bwidth/3,overflow:"hidden"}}>{lec.product.name}</p> </TableCell>
