                ...
                { lectures.map( 
                  (lec, index, arr) => {
                    ...
                    return( <TableRow key={lec.id} className = {tableClasses.root} style={{backgroundColor:"#FFFFFF"}}>
                              {/* <TableCell align="center"> <p style={{textOverflow:"ellipsis",whiteSpace:"nowrap",wordWrap:"normal",width:Bwidth/12 ,overflow:"hidden"}}>{category_content}</p> </TableCell> */}
                              <TableCell align="center" stlye={{width:"100px"}}> <p style={{textOverflow:"ellipsis",whiteSpace:"nowrap",wordWrap:"normal",width:Bwidth/3,overflow:"hidden"}}>{lec.product.name}</p> </TableCell>
                              {/* <TableCell align="center"> {lec.product.company} </TableCell> */}
                              <TableCell align="center" stlye={{width:"30px"}}> 
